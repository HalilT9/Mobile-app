...
class _CameraScreenState extends State<CameraScreen> with TickerProviderStateMixin {
  ...
  Future<Map<String, dynamic>> _simulateAIScan() async {
    ...
    final results = [
      {'name': 'AI: Izgara Tavuk ve Brokoli', 'calories': 450},
      {'name': 'AI: Bol Peynirli Pizza', 'calories': 800},
      {'name': 'AI: Yoğurt ve Meyve', 'calories': 180},
      {'name': 'AI: Somon ve Sebze', 'calories': 520},
      {'name': 'AI: Makarna Carbonara', 'calories': 650},
    ];
                                ...
                                child: Stack(
                                  ...
                                  children: [
                                    ...
                                    ...List.generate(3, (index) {
                                      return Transform.scale(
                                        scale: 1.0 + (index * 0.15) + (_pulseAnimation.value * 0.1),
                                        child: Container(
                                          width: 220 + (index * 40),
                                          height: 220 + (index * 40),
                                          decoration: BoxDecoration(
                                      ...
                                      decoration: BoxDecoration(
                                        gradient: const LinearGradient(
                                          ...
                                          colors: [
                                            ...
                                            Color(0xFF81C784), // Light green tone
