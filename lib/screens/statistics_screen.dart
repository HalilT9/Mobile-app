...
class _StatisticsScreenState extends State<StatisticsScreen> with SingleTickerProviderStateMixin {
                  ...
                  background: Container(
                    decoration: const BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          const Color(0xFFFFFEF7), // Cream white
                          Colors.white,
                        ],
                      ),
                    ),
  ...
  Widget _buildAnalysisCard(
    ...
    String statusText = 'Hedefe $difference kcal kaldı';
    IconData statusIcon = Icons.trending_up_rounded;

    if (difference < 0) {
      statusColor = const Color(0xFFEF4444);
      statusText = 'Hedef ${difference.abs()} kcal aşıldı';
      statusIcon = Icons.trending_down_rounded;
    } else if (difference < (goal * 0.1)) {
      statusColor = const Color(0xFFF59E0B);
      statusText = 'Hedefe çok yaklaştınız!';
                        ...
                        SnackBar(
                          content: const Row(
                            children: [
                              ...
                              SizedBox(width: 12),
                              Text(
                                'Hedefler başarıyla güncellendi!',
