...
import '../providers/auth_provider.dart'; // EKLENDİ: Kimlik için gerekli
...
class _StatisticsScreenState extends State<StatisticsScreen>
                  ...
                  SliverAppBar(
                    ...
                    actions: [
                      IconButton(
                        icon: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                // Düzeltildi: withValues -> withOpacity
                      ...
                      IconButton(
                        ...
                        onPressed: () =>
                            _showGoalSettingsDialog(context, provider),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: const TextStyle(
                            fontSize: 14,
                            color: Color(0xFF8D6E63), // Brown grey
                            fontWeight: FontWeight.w500,
                          ),
                        ),
                      ],
  ...
  void _showGoalSettingsDialog(BuildContext context, MealProvider provider) {
    ...
    final weeklyController =
        TextEditingController(text: provider.weeklyCalorieGoal.toString());
    final monthlyController =
        TextEditingController(text: provider.monthlyCalorieGoal.toString());
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      // Düzeltildi: withValues -> withOpacity
                      color: const Color(0xFFA0522D).withOpacity(0.4),
                      blurRadius: 20,
                      offset: const Offset(0, 10),
                    ),
                  ],
                ...
                child: Material(
                  ...
                  child: InkWell(
                    onTap: () {
                      ...
                      // AuthProvider'dan kullanıcı ID'si alınıyor
                      final authProvider =
                      ...
                      final weekly = int.tryParse(weeklyController.text) ??
                          provider.weeklyCalorieGoal;
                      final monthly = int.tryParse(monthlyController.text) ??
                          provider.monthlyCalorieGoal;

                      // Fonksiyonlara userId gönderiliyor
                      provider.updateDailyCalorieGoal(userId, daily);
                      provider.updateWeeklyCalorieGoal(userId, weekly);
                      provider.updateMonthlyCalorieGoal(userId, monthly);
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              prefixIcon:
                  Icon(Icons.local_fire_department_rounded, color: color),
              suffixText: 'kcal',
